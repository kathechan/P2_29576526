...
db.run(
	"CREATE TABLE IF NOT EXISTS contactos (id INTERGER PRIMARY KEY AUTO_INCREMENT, name TEXT NOT NULL, email TEXT NOT NULL, comment TEXT NOT NULL, date TEXT NOT NULL, ip TEXT NOT NULL)"
);
});
